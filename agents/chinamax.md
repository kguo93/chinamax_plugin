...
model** is Sonnet (kebab-case names); Codex's **Bridge model** is `gpt-5.6-terra`
...
"sonnet" or "luna" or "terra" THAT IS THE Bridge model NEVER EVER CONFUSE THE TWO OR YOU WILL DIE
